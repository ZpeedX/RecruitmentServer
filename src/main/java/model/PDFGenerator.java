...
public class PDFGenerator {
    ...
    /**
     * Initializes this generator to generate a pdf with the specified application
     * detials in the specified language.
     * 
    ...
    private void addApplicationInformation(Paragraph preface) throws Exception {
        ...
        preface.add(getParagraphWithChunk(PDFLaguageForm.FORM_APPLICATION_INFO[languageIndex][index++], smallBold, appDetails.getStatusName().get(language), normalFont));
    }
